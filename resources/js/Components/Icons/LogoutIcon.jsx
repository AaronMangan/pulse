export function LogoutIcon(props) {
    return (
      <svg className="flex fill-primary justify-center w-12 h-12 mb-2 text-gray-500 place-items-center dark:text-gray-400"  fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" {...props}>
