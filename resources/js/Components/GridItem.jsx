...
export default function GridBox({ title, blurb, href, as = 'button', method, icon }) {
    const getIcon = (icon) => {
        switch(icon) {
            case 'document':
    ...
    return (
        <Link className="" href={href} as={as} method={method}>
            <div className="flex flex-col h-full rounded-md max-h-25">
                <div className="items-center justify-center h-full max-w-sm p-6 bg-white rounded-lg shadow dark:bg-gray-800">
