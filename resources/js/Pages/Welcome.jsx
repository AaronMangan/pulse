                ...
                <div className="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
                    <div className="p-4 bg-white shadow sm:p-8 sm:rounded-lg">
                        <div className='flex flex-col items-center pt-6 sm:justify-center sm:pt-0'>
                            <ApplicationLogo className="w-1/2 text-gray-500 h-1/2 hover:text-blue-300 text-primaryDark" />
                            <h2 className='font-bold text-primaryDark hover:text-blue-300 text-7xl'>Pulse</h2>
